...
- After that, start airflow by running `aws-vault exec flux-airflow-local -- docker compose up -d --build` 
  ...
  - You can confirm the environemnt variable defined [HERE](https://github.com/Federated-Engineers/flux-airflow/blob/main/docker-compose.yaml#L64-L67) inside any of your airflow service container.
